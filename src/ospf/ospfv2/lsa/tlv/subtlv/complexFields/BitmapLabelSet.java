package ospf.ospfv2.lsa.tlv.subtlv.complexFields;

import ospf.ospfv2.lsa.tlv.subtlv.MalformedOSPFSubTLVException;
import protocol.commons.ByteHandler;
import rsvp.RSVPProtocolViolationException;
import rsvp.constructs.gmpls.DWDMWavelengthLabel;
...
public class BitmapLabelSet  extends LabelSetField {
	...
	public BitmapLabelSet(byte[] bytes, int offset) throws MalformedOSPFSubTLVException, RSVPProtocolViolationException {
	...
	@Override
	public void decode() throws MalformedOSPFSubTLVException, RSVPProtocolViolationException {
		int offset=4;
