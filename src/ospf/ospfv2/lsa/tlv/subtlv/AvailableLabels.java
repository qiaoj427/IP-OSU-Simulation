package ospf.ospfv2.lsa.tlv.subtlv;

import ospf.ospfv2.lsa.tlv.subtlv.complexFields.*;
...
public class AvailableLabels extends OSPFSubTLV {
	...
	public AvailableLabels(byte[] bytes, int offset) throws MalformedOSPFSubTLVException, RSVPProtocolViolationException {
		super(bytes,offset);		
		decode();
	}
	@Override
	public void encode() throws MalformedOSPFSubTLVException, RSVPProtocolViolationException {
